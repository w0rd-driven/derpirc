...
namespace derpirc.Data.Models
{
    ...
    public partial class MentionItem : IBaseModel, IMessageItem, INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public MentionItem()
        {
            this._Summary = default(EntityRef<Mention>);
            OnCreated();
        }
        ...
        [global::System.Data.Linq.Mapping.AssociationAttribute(Name = "FK_Mention_MentionItem", Storage = "_Summary", ThisKey = "SummaryId", OtherKey = "Id", IsForeignKey = true)]
        public Mention Summary
        {
            ...
            set
            {
                Mention previousValue = this._Summary.Entity;
